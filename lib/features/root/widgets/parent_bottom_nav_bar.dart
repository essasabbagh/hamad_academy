...
import '../providers/parent_root_notifier.dart';

class ParentBottomNavBar extends ConsumerWidget {
  const ParentBottomNavBar({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final index = ref.watch(parentRootProvider);
    final state = ref.read(parentRootProvider.notifier);
