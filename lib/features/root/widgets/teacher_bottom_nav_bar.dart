...
import '../providers/teacher_root_notifier.dart';

class TeacherBottomNavBar extends ConsumerWidget {
  const TeacherBottomNavBar({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final index = ref.watch(teacherRootProvider);
    final state = ref.read(teacherRootProvider.notifier);
